...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.obscure.googleplus.js')
	...
	f = os.path.join(cwd,'Classes','ComObscureGoogleplusModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.obscure.googleplus.js']
